...
public class IteratorSetting {
     ...
     *
     * @param priority determines the order in which iterators are applied (system iterators are always applied first, then user-configured iterators, lowest priority
     *                 first)
     */
