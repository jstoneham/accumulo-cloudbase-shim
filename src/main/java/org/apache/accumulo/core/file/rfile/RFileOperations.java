...
import com.texeltek.accumulocloudbaseshim.BlockCacheShim;
import com.texeltek.accumulocloudbaseshim.ByteSequenceShim;
import com.texeltek.accumulocloudbaseshim.FileSKVIteratorShim;
import com.texeltek.accumulocloudbaseshim.FileSKVWriterShim;
...
public class RFileOperations extends FileOperations {
    ...
    public final cloudbase.core.file.rfile.RFileOperations impl;

    public RFileOperations(cloudbase.core.file.rfile.RFileOperations impl) {
        super(impl);
        this.impl = impl;
    }
    ...
    public FileSKVIterator openReader(String file, Range range, Set<ByteSequence> columnFamilies, boolean inclusive, FileSystem fs, Configuration conf, AccumuloConfiguration tableConf, BlockCache dataCache, BlockCache indexCache) throws IOException {
        return new FileSKVIteratorShim(impl.openReader(file, range.impl, ByteSequenceShim.cloudbaseSet(columnFamilies), inclusive, fs, conf, tableConf.impl, ((BlockCacheShim) dataCache).impl, ((BlockCacheShim) indexCache).impl));
    }
